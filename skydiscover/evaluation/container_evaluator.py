...
from skydiscover.llm.cost import merge_usage
...
class ContainerizedEvaluator:
    ...
    def _parse_output(self, stdout: str) -> EvaluationResult:
        ...
        # Merge any LLM token usage the in-container evaluator reported, so calls
        # made inside the container show up in the host's cost tracker/dashboard.
        merge_usage(data.get("llm_usage"))
