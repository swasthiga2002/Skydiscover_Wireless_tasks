...
class DiscoveryController:
    ...
    def __init__(self, controller_input: DiscoveryControllerInput):
        ...
        evaluator_env_vars = dict(controller_input.evaluator_env_vars or {})
        if controller_input.output_dir:
            evaluator_env_vars.setdefault(
                "SKYDISCOVER_OUTPUT_DIR", os.path.abspath(controller_input.output_dir)
            )
